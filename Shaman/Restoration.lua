...
--     (((A.Zone ~= "arena" or not A.InstanceInfo.isRated)) or
--         ((A.Zone == "arena" or A.InstanceInfo.isRated))) and useDispel and
--     Unit(unitID):HasDeBuffs(342938) == 0 and ( -- MouseOver
-- (Unit("mouseover"):IsExists() and MouseHasFrame() and
--     not IsUnitEnemy("mouseover") and
--     AuraIsValid(mouseover, "UseDispel", "Dispel")) or
--     ((not A.GetToggle(2, "mouseover") or not Unit("mouseover"):IsExists() or
--         IsUnitEnemy("mouseover")) and not IsUnitEnemy(unitID) and
--         A.GetToggle(2, "DispelSniper") and
--         AuraIsValid(unitID, "UseDispel", "Dispel"))) then
